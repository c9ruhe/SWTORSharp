...
namespace SWTORSharp.Core
{
    ...
    public class ItemList2
    {
        ...
        [JsonProperty("number_of_items_with_model")]
        public long NumberOfItemsWithModel { get; set;
        public class Convert
        {
            // Serialize/deserialize helpers
